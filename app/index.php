...
<body>
    ...
    <form method="POST" action="process.php">
        ...
        <div class="form-group">
            <label for="question1">1. Как вы оцениваете качество нашего сервиса? *</label>
        ...
        <div class="form-group">
            <label for="question2">2. Что нам следует улучшить? *</label>
            <textarea id="question2" name="question2" rows="4" required></textarea>
        </div>
        
        <div class="form-group">
            <label>3. Порекомендуете ли вы нас друзьям? *</label><br>
